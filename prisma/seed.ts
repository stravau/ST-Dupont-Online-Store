...
const SPLIT_PRODUCT: Record<string, SplitPart[]> = {
  // Leather bundles — generated by scripts/gen-leather-splits.ts from the
  // www catalogue (one product per item-type + price). Spread first so the
  // hand-written entries below can override if ever needed.
  ...LEATHER_SPLITS,
