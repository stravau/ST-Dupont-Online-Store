...
export const LEATHER_NAV: readonly MobileNavEntry[] = [
  ...
  },
  {
    ...
    allHref: "/c/pele?g=women",
    items: [
      { label: L("Mala de Mão", "Hand Bags"),     href: "/t/bags?type=hand-bag&g=women" },
      { label: L("Trunks", "Trunks"),             href: "/t/bags?type=trunk&g=women" },
      { label: L("Baguette", "Baguette"),         href: "/t/bags?type=baguette&g=women" },
      { label: L("Tote", "Tote"),                 href: "/t/bags?type=tote&g=women" },
    ],
  },
  {
    kind: "section",
    title: L("Unissexo", "Unisex"),
    allHref: "/c/pele?g=unisex",
    items: [
      { label: L("Mochilas", "Backpacks"),        href: "/t/bags?type=backpacks&g=unisex" },
      { label: L("Tiracolo", "Crossbody"),        href: "/t/bags?type=crossbody&g=unisex" },
      { label: L("Mala de Ombro", "Shoulder Bags"),href: "/t/bags?type=shoulder-bag&g=unisex" },
      { label: L("Tote", "Tote"),                 href: "/t/bags?type=tote&g=unisex" },
      { label: L("Bolsas", "Pouches"),            href: "/t/bags?type=pouches&g=unisex" },
    ],
  },
  {
    kind: "section",
