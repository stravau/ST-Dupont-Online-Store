...
/**
 * Mesma coisa mas para dentro de um hero navy, onde o outline claro do
 * BoutiqueScopeTabs desaparece contra o fundo escuro.
 */
export function BoutiqueScopeTabsOnDark({
  scope,
  allowed,
  hrefFor,
}: {
