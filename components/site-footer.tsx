...
export function SiteFooter({ lang }: { lang: Locale }) {
  ...
  return (
    <footer className="monogram-bg mt-24 text-cream">
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-6 py-24 text-center md:grid-cols-3 md:text-left">
        <div className="reveal flex flex-col items-center md:items-start">
          <Logo variant="light" width={244} className="w-[244px]" />
          <p className="overline mt-5">{dict.footer.tagline}</p>
        </div>

        <div id={CONTACT_ANCHOR} className="reveal reveal-d1 scroll-mt-28">
          <p className="overline mb-6">{dict.footer.boutique}</p>
          <address className="space-y-1.5 text-sm leading-relaxed not-italic text-cream/70">
            <p>{STORE.venue}</p>
          ...
          <div className="mt-7 flex flex-col items-center gap-3 text-sm text-cream/70 md:items-start">
        ...
        <div className="reveal reveal-d2">
          <p className="overline mb-6">{dict.footer.legal}</p>
      ...
      <div className="reveal reveal-d3 border-t border-cream/10">
        <p className="mx-auto max-w-7xl px-6 py-7 text-center text-xs tracking-widest text-cream/40">
