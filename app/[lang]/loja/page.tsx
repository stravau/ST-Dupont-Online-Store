  ...
  return (
    <div>
      {/* Hub header — soft cream intro that names the page as a two-
          ...
          section below. */}
      <header className="mx-auto max-w-4xl px-6 pt-14 pb-8 text-center md:pt-16 md:pb-10">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {STORES.map((store) => (
            <a
              ...
              className="monogram-bg group relative block h-56 overflow-hidden text-cream sm:h-72"
            >
          ...
          <div className="mx-auto max-w-6xl px-6 py-14 md:py-16">
            ...
            <div className="grid gap-10 md:grid-cols-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-4 flex md:flex-1">
                  <StoreMap
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 inline-flex items-center justify-center gap-3 bg-ink py-3.5 text-xs tracking-[0.22em] text-cream uppercase transition-colors duration-300 hover:bg-gold hover:text-ink"
                >
